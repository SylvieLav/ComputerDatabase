	...
	<header class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			...
			<div class="pull-right">
				<a class="btn btn-default" href="<c:url value="/logout" />"><spring:message
						key="label.logout" /></a>
			</div>
		</div>
	</header>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-8 col-xs-offset-2 box">
					<h1>
						<spring:message key="label.addComputer" />
					</h1>
					<form:form method="POST" modelAttribute="computerDTO" action="">
						...
						<div class="actions pull-right">
							<input type="submit" value="<spring:message key="label.add" />"
